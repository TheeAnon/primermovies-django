...
function MainSlider() {
  return (
    <div className="flex-shrink-0 w-full md:w-2/3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-gray-900 via-gray-800 to-transparent text-white rounded-lg">
        ...
        <div className="flex w-full">
          <span className="text-sm flex-grow">S06E05</span>
          <div className="float-right p-0.5 rounded flex">
            <svg
