const PortraitPoster = ({ image, title, link, episode, rating }) => {
  return (
    <div className="w-full h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-1 bg-gradient-to-t from-gray-900 via-gray-800 to-transparent text-white">
        <a href={link}>
          <h5 className="text-md font-semibold tracking-tight hover:text-blue-600">
            {title}
          </h5>
        </a>
